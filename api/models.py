...
class Trail(models.Model):
    ...
    number_of_steps = models.PositiveSmallIntegerField(default=0)
    autor = models.CharField(max_length=255, default='')

    def update_step_count(self):
        self.number_of_steps = self.steps.count()
        self.save(update_fields=['number_of_steps'])
...
class Step(models.Model):
    ...
    trail = models.ForeignKey(Trail, related_name='steps', on_delete=models.CASCADE)
